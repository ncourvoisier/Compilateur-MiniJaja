...
public class Division extends ASTExpr {

    private ASTExpr expr1;
    private ASTExpr expr2;

    public Division(ASTExpr expr1, ASTExpr expr2) {
        this.expr1 = expr1;
        this.expr2 = expr2;
    }
    ...
    public CompilationCouple compiler(int actual) {
        ...
        return new CompilationCouple(JCodes.concatenate(e1.jCodes, JCodes.concatRight(e2.jCodes, new OpBinaire(OpBinaire.Operandes.DIV))), e1.taille + e2.taille + 1);
    }
}
